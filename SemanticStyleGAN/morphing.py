...
for pt in pt_list :
  ...
  cmd2 = f'PYTHONPATH=.:$PYTHONPATH python visualize/generate_morph.py {pt}  --outdir results/interpolation --latent_start {npt_list[1]} --latent_end {npt_list[0]} --step 100'
